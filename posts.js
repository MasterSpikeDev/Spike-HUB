...
window.POSTS = [
    {
        ...
        links: [
            { label: { pt: "Página do projeto", en: "Project page" }, href: "https://mcpedl.com/sheikah-s-legacy" }
        ],
        videos: [
            { label: { pt: "Trailer (YouTube)", en: "Trailer (YouTube)" }, href: "https://www.youtube.com/watch?v=CerxwsElNTo" }
        ]
    },
    {
    ...
    },
    {
        ...
        links: [
            ...
            { label: { pt: "Trailer (YouTube)", en: "Trailer (YouTube)" }, href: "https://www.youtube.com/watch?v=vJ_1bDuXBbo" }
